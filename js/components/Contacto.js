  ...
  <div>
      <v-container class="text-center ">
          <v-row>
            ...
            <v-row>
              <v-col align-self="end" cols="12" xl="12" lg="12" md="12" sm="12" xs="12">
                <p class="black--text texto-hat texto-contacto">Contamos con parqueadero gratuito para nuestros clientes<br><span class="black--text texto-opera texto-contacto">Carrera 13 # 40c - 10 Chapinero Central</span></p>
                <img src="img/edificio/Parqueadero.jpg" class="localizacion" height="300px" with="100px"/>
              </v-col>
            </v-row>
            <v-row>
              <v-col align-self="end" cols="12" xl="12" lg="12" md="12" sm="12" xs="12">
